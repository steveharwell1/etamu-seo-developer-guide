...
const config = {
  ...
  organizationName: 'East Texas A&M University', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/steveharwell1/etamu-seo-developer-guide/blob/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/45press-tamuc/tamuc-edu/',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        links: [
          {
            ...
            items: [
              ...
              {
                label: 'Docs Github',
                href: 'https://github.com/steveharwell1/etamu-seo-developer-guide',
              },
              {
                label: 'Theme Github',
                href: 'https://github.com/45press-tamuc/tamuc-edu',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} East Texas A&M University, Inc. Built with Docusaurus.`,
      },
      prism: {
